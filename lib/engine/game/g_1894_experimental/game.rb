  ...
  module Game
    module G1894Experimental
      class Game < Game::Base
        include_meta(G1894Experimental::Meta)
        include G1894Experimental::Map
        include G1894Experimental::Entities
        ...
        def stock_round
          G1894Experimental::Round::Stock.new(self, [
            G1894Experimental::Step::BuySellParShares,
          ])
        end
        ...
        def operating_round(round_num)
          Engine::Round::Operating.new(self, [
            ...
            G1894Experimental::Step::SpecialBuy,
            Engine::Step::HomeToken,
            G1894Experimental::Step::RedeemShares,
            G1894Experimental::Step::Track,
            G1894Experimental::Step::Token,
            G1894Experimental::Step::Route,
            G1894Experimental::Step::Dividend,
            Engine::Step::DiscardTrain,
            G1894Experimental::Step::BuyTrain,
            [Engine::Step::BuyCompany, { blocks: true }],
            G1894Experimental::Step::UpdateTokens,
          ], round_num: round_num)
        end
