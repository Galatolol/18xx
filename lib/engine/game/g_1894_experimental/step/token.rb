      ...
      module Step
        class Token < Engine::Step::Token
          ...
          def place_token(entity, city, token, connected: true, extra_action: false, special_ability: nil)
            if city.hex.name == Engine::Game::G1894Experimental::Game::LONDON_HEX
              raise GameError,
          ...
          def process_place_token(action)
            ...
            return if !Engine::Game::G1894Experimental::Game::BROWN_CITY_TILES.include?(tile.name) || tile.reservations.empty?
