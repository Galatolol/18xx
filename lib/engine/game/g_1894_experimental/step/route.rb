      ...
      module Step
        class Route < Engine::Step::Route
          ...
          def route_includes_london?(routes)
            routes.flat_map(&:connection_hexes).include?(Engine::Game::G1894Experimental::Game::LONDON_HEX)
          end

          def available_hex(entity, hex)
            return @game.ferry_marker?(entity) if hex.id == Engine::Game::G1894Experimental::Game::LONDON_HEX
