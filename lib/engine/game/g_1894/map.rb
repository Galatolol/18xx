      ...
      module Map
        TILES = {
          ...
          'X4' => {
            'count' => 1,
            'color' => 'green',
            'code' => 'city=revenue:30,loc:0.5;city=revenue:30,loc:2.5;path=a:0,b:_0;path=a:1,b:_0;path=a:2,b:_1;path=a:3,b:_1;label=P',
          },
          'X5' => {
            'count' => 1,
            'color' => 'green',
            'code' => 'city=revenue:30,loc:0.5;city=revenue:30,loc:3.5;path=a:0,b:_0;path=a:1,b:_0;path=a:3,b:_1;path=a:4,b:_1;label=P',
          },
          'X6' => {
            'count' => 1,
            'color' => 'green',
          ...
          'X7' => {
            'count' => 1,
            'color' => 'brown',
            'code' => 'city=revenue:80,loc:0.5;city=revenue:80,slots:2;path=a:0,b:_0;path=a:1,b:_0;path=a:2,b:_1;path=a:3,b:_1;label=P',
          },
          'X8' => {
            'count' => 1,
            'color' => 'brown',
            'code' => 'city=revenue:80,loc:0.5;city=revenue:80,slots:2;path=a:0,b:_0;path=a:1,b:_0;path=a:3,b:_1;path=a:4,b:_1;label=P',
          },
          'X9' => {
            'count' => 1,
            'color' => 'brown',
          ...
          'X15' => {
            'count' => 1,
            'color' => 'brown',
            'code' => 'city=revenue:40,loc:0.5;city=revenue:40,loc:3.5;path=a:0,b:_0;path=a:1,b:_0;path=a:3,b:_1;path=a:4,b:_1',
          },
        }.freeze
        ...
        LOCATION_NAMES = {
          ...
          HEXES = {
            ...
            red: {
              ...
              ['I2'] => 'offboard=revenue:yellow_30|brown_40;path=a:2,b:_0;path=a:3,b:_0;path=a:4,b:_0',
              ['I18'] => 'offboard=revenue:0,hide:1;label=?;path=a:1,b:_0;path=a:2,b:_00',
            },
          }.freeze
        end
      end
